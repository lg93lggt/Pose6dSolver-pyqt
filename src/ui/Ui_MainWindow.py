...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.action_cal_angle = QtWidgets.QAction(MainWindow)
        self.action_cal_angle.setObjectName("action_cal_angle")
        ...
        self.menu2.addSeparator()
        self.menu2.addAction(self.action_cal_angle)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_cal_angle.setText(_translate("MainWindow", "角度计算"))
